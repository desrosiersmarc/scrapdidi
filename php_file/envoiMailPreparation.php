...
$message_html =
	"<html>
		...
		<body>
			...
			<p $styleP>Nous avons bien reçu le réglement pour votre commande <i>(n° $no_order)</i>.</p>
			<p $styleP>Vous recevrez un nouveau mail au moment de l'expédition</p>
			<p $styleP>Bonne journée</p>
		</body>
	</html>";
...
//=====Définition du sujet.
$sujet = "[scrapdidi.fr]-Réception de votre réglement - commande n°$no_order ";
...
echo "
	<div class='messageDivContent'>
		<div class='messageDiv'>
			<p> Commande n°$no_order - Le mail a bien été envoyé </p>
		</div>
	</div>
";
