...
$message_html =
  "<html>
    ...
    <body>
      ...
      <p $styleP>Votre commande <i>(n° $no_order)</i> vient d'être expédiée.</p>
      <p $styleP>Vous pouvez suivre votre colis à l'aide du no suivant : 123456</p>
...
//=====Définition du sujet.
$sujet = "[scrapdidi.fr]-Expédition de votre commande n°$no_order ";
...
echo "
  <div class='messageDivContent'>
    <div class='messageDiv'>
      <p> Commande n°$no_order - Le mail 'expédition' a bien été envoyé </p>
    </div>
  </div>
";
