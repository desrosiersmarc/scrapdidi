...
<div class="payement-procedure">
  ...
  <hr>
  <strong>Vous avez choisi de régler par Paypal. Voici un bref récapitulatif de votre commande</strong>
  <ul>
    ...
    <li>cliquez sur ce <strong><a href="#">lien</a></strong> pour accèder au site paypal</li>
